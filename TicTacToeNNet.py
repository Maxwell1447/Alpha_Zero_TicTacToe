...
#         self.v = Dense(1, activation='tanh', name='v')(s_fc2)                    # batch_size x 1
        ...
        fc = Dropout(args.dropout)(Activation('relu')(BatchNormalization(axis=1)(Dense(50)(Flatten()(self.input_boards)))))
        self.pi = Dense(self.action_size, activation='softmax', name='pi')(fc)
        self.v = Dense(1, activation='tanh', name='v')(fc) 
